  ...
  <div className="fl bdy">
    <div className="bdyInner">
      ...
      <div className="fl searchInBody mb45">
        <span className="searchInBodyH1">Paste Instagram Reels link:</span>
        <input type="text" className="inpSearch inpSearchBody" autoCorrect="off" autoCapitalize="none" placeholder="https://www.instagram.com/reel/CHvspaHHFC7/" />
      ...
      <div className="fl description mb45">
        <h1>Download and View Full Resolution Instagram Reels</h1>
        <p>With the Instagram Reels downloader, you can download or view Instagram Reels videos in full resolution to your phone and computer. Instagram Reels does not allow you to download videos. For this reason, you can only download Reels videos using the online free download tools.</p>
        <p>Downloading Instagram Reels is very easy with InstaBig. Copy the Reels video link you want to download and paste it into the search box above and click on the Reels result found. The Instagram Reels video you want to download will be displayed. You can download the Reels video to your phone and computer by clicking the Download button just below. You can also view it in full resolution if you want.</p>
      </div>
