...
const handleSubmit = () => {
  // console.log(UserDataFetchApi,"UserDataFetchApi")
  ...
  <div className="con">
    <div className="conInner">
      ...
      <div className="fl conSearch">
        <input type="text" className="inpSearch" value={user} onChange = { (e) =>setUser(e.target.value)} autoCorrect="off" autoCapitalize="none" placeholder="Search username" />
        <a id="searchButton" href="javascript:void(0)" onClick={handleSubmit}>
