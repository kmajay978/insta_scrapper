  ...
  <div className="fl bdy">
    <div className="bdyInner">
      ...
      <div className="fl ads mb45">
        {/* IGTV Home 1 */}
        <ins className="adsbygoogle" style={{display: 'block'}} data-ad-client="ca-pub-6411740468955874" data-ad-slot={6131996608} data-ad-format="auto" data-full-width-responsive="true" />
      </div>
      ...
      <div className="fl searchInBody mb45">
        <span className="searchInBodyH1">Paste IGTV video link:</span>
        <input type="text" className="inpSearch inpSearchBody" autoCorrect="off" autoCapitalize="none" placeholder="https://www.instagram.com/tv/CAErDMyHnMO/" />
      ...
      <div className="fl description mb45">
        <h1>Download and View Instagram IGTV Videos</h1>
        <p>With Instagram IGTV downloader, you can view or download Instagram IGTV videos in full resolution to your phone and computer. Instagram does not allow users to download IGTV videos. You can only download Instagram IGTV videos using online free download tools.</p>
        <p>Downloading Instagram IGTV videos is very easy with InstaBig. Paste the link of the IGTV video you want to download in the search box above and click on the IGTV video found from the search results. The IGTV video will be displayed. You can download Instagram IGTV videos in full resolution to your phone and computer by clicking the Download button just below.</p>
      </div>
      ...
      <ul className="fl articleList mb45">
        ...
        <li className="fl articles">
          <div className="fl articleInner">
            ...
            <div className="fl articleBody">
              <a href="/" title="Download Instagram Photos and Videos">
